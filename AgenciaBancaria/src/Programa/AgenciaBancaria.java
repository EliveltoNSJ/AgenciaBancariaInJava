...
public class AgenciaBancaria {
	...
	public static void depositar() {
		...
		if (conta != null) {
			Double valorDepositado = Double.parseDouble(JOptionPane.showInputDialog("Qual valor deseja depositar:  "));
	...
	public static void transferir() {
		...
		if (contaRemetente != null) {
			...
			JOptionPane.showMessageDialog(null, "A conta para tranferência não foi encontrada");
		}
		operacoes();
	}
